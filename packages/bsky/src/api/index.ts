...
import listParaCabildeoPositions from './com/para/civic/listCabildeoPositions.js'
...
import getParaPostSubscription from './com/para/notification/getPostSubscription.js'
import putParaPostSubscription from './com/para/notification/putPostSubscription.js'
import getParaCommunityAlignment from './com/para/raq/getCommunityAlignment.js'
import getParaProposals from './com/para/raq/getProposals.js'
import getParaUserAlignment from './com/para/raq/getUserAlignment.js'
import getParaPostMeta from './com/para/social/getPostMeta.js'
...
export default function (server: Server, ctx: AppContext) {
  ...
  getParaOpenQuestionThread(paraServer, ctx)
  ...
  listParaCollections(paraServer, ctx)
  ...
  getParaCommunityAlignment(paraServer, ctx)
  getParaProposals(paraServer, ctx)
}
