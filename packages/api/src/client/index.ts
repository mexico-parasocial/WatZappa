...
import * as ComParaCivicGetOpenQuestionThread from './types/com/para/civic/getOpenQuestionThread.js'
...
import * as ComParaCivicOpenQuestion from './types/com/para/civic/openQuestion.js'
import * as ComParaCivicOpenQuestionVote from './types/com/para/civic/openQuestionVote.js'
...
import * as ComParaCollectionGetCollection from './types/com/para/collection/getCollection.js'
...
import * as ComParaCommunityGovernanceConfig from './types/com/para/community/governanceConfig.js'
...
import * as ComParaOfficialController from './types/com/para/official/controller.js'
import * as ComParaOfficialEntity from './types/com/para/official/entity.js'
import * as ComParaPost from './types/com/para/post.js'
import * as ComParaRaqAssessment from './types/com/para/raq/assessment.js'
import * as ComParaRaqAxisVote from './types/com/para/raq/axisVote.js'
import * as ComParaRaqDefs from './types/com/para/raq/defs.js'
import * as ComParaRaqGetCommunityAlignment from './types/com/para/raq/getCommunityAlignment.js'
import * as ComParaRaqGetProposals from './types/com/para/raq/getProposals.js'
import * as ComParaRaqGetUserAlignment from './types/com/para/raq/getUserAlignment.js'
import * as ComParaRaqProposal from './types/com/para/raq/proposal.js'
import * as ComParaRaqProposalAnswer from './types/com/para/raq/proposalAnswer.js'
import * as ComParaRaqProposalVote from './types/com/para/raq/proposalVote.js'
...
import * as ComParaSortitionProof from './types/com/para/sortition/proof.js'
...
export * as ComParaAlphaCreateInvite from './types/com/para/alpha/createInvite.js'
...
export * as ComParaCivicGetOpenQuestionThread from './types/com/para/civic/getOpenQuestionThread.js'
...
export * as ComParaCivicOpenQuestion from './types/com/para/civic/openQuestion.js'
export * as ComParaCivicOpenQuestionVote from './types/com/para/civic/openQuestionVote.js'
...
export * as ComParaCollectionGetCollection from './types/com/para/collection/getCollection.js'
...
export * as ComParaCommunityGovernanceConfig from './types/com/para/community/governanceConfig.js'
...
export * as ComParaOfficialController from './types/com/para/official/controller.js'
export * as ComParaOfficialEntity from './types/com/para/official/entity.js'
export * as ComParaPost from './types/com/para/post.js'
export * as ComParaRaqAssessment from './types/com/para/raq/assessment.js'
export * as ComParaRaqAxisVote from './types/com/para/raq/axisVote.js'
export * as ComParaRaqDefs from './types/com/para/raq/defs.js'
export * as ComParaRaqGetCommunityAlignment from './types/com/para/raq/getCommunityAlignment.js'
export * as ComParaRaqGetProposals from './types/com/para/raq/getProposals.js'
export * as ComParaRaqGetUserAlignment from './types/com/para/raq/getUserAlignment.js'
export * as ComParaRaqProposal from './types/com/para/raq/proposal.js'
export * as ComParaRaqProposalAnswer from './types/com/para/raq/proposalAnswer.js'
export * as ComParaRaqProposalVote from './types/com/para/raq/proposalVote.js'
...
export * as ComParaSortitionProof from './types/com/para/sortition/proof.js'
...
export class ChatBskyGroupNS {
  ...
  getJoinLinkPreviews(
    params?: ChatBskyGroupGetJoinLinkPreviews.QueryParams,
    opts?: ChatBskyGroupGetJoinLinkPreviews.CallOptions,
  ): Promise<ChatBskyGroupGetJoinLinkPreviews.Response> {
    return this._client.call(
...
export class ComParaAgentNS {
  ...
  getConversation(
    params?: ComParaAgentGetConversation.QueryParams,
    opts?: ComParaAgentGetConversation.CallOptions,
  ): Promise<ComParaAgentGetConversation.Response> {
    return this._client.call(
  ...
  sendMessage(
    data?: ComParaAgentSendMessage.InputSchema,
    opts?: ComParaAgentSendMessage.CallOptions,
  ): Promise<ComParaAgentSendMessage.Response> {
    return this._client.call('com.para.agent.sendMessage', opts?.qp, data, opts)
  }
}

export class ComParaAlphaNS {
  _client: XrpcClient
  ...
  createInvite(
    data?: ComParaAlphaCreateInvite.InputSchema,
    opts?: ComParaAlphaCreateInvite.CallOptions,
  ): Promise<ComParaAlphaCreateInvite.Response> {
    return this._client.call(
      'com.para.alpha.createInvite',
      opts?.qp,
      data,
      opts,
    )
  ...
  getAccess(
    params?: ComParaAlphaGetAccess.QueryParams,
    opts?: ComParaAlphaGetAccess.CallOptions,
  ): Promise<ComParaAlphaGetAccess.Response> {
    return this._client.call(
      'com.para.alpha.getAccess',
      params,
      undefined,
      opts,
    )
  ...
  getRolloutStatus(
    params?: ComParaAlphaGetRolloutStatus.QueryParams,
    opts?: ComParaAlphaGetRolloutStatus.CallOptions,
  ): Promise<ComParaAlphaGetRolloutStatus.Response> {
    return this._client.call(
  ...
  requestAccess(
    data?: ComParaAlphaRequestAccess.InputSchema,
    opts?: ComParaAlphaRequestAccess.CallOptions,
  ): Promise<ComParaAlphaRequestAccess.Response> {
    return this._client.call(
...
export class ComParaCivicNS {
  _client: XrpcClient
  amendment: ComParaCivicAmendmentRecord
  cabildeo: ComParaCivicCabildeoRecord
  delegation: ComParaCivicDelegationRecord
  openQuestion: ComParaCivicOpenQuestionRecord
  openQuestionVote: ComParaCivicOpenQuestionVoteRecord
  position: ComParaCivicPositionRecord
  vote: ComParaCivicVoteRecord

  constructor(client: XrpcClient) {
    this._client = client
    this.amendment = new ComParaCivicAmendmentRecord(client)
    this.cabildeo = new ComParaCivicCabildeoRecord(client)
    this.delegation = new ComParaCivicDelegationRecord(client)
    this.openQuestion = new ComParaCivicOpenQuestionRecord(client)
    this.openQuestionVote = new ComParaCivicOpenQuestionVoteRecord(client)
    this.position = new ComParaCivicPositionRecord(client)
    this.vote = new ComParaCivicVoteRecord(client)
  }

  castVote(
    data?: ComParaCivicCastVote.InputSchema,
    opts?: ComParaCivicCastVote.CallOptions,
  ): Promise<ComParaCivicCastVote.Response> {
    return this._client
      .call('com.para.civic.castVote', opts?.qp, data, opts)
      .catch((e) => {
        throw ComParaCivicCastVote.toKnownErr(e)
      })
  }
  ...
  getOpenQuestionThread(
    params?: ComParaCivicGetOpenQuestionThread.QueryParams,
    opts?: ComParaCivicGetOpenQuestionThread.CallOptions,
  ): Promise<ComParaCivicGetOpenQuestionThread.Response> {
    return this._client
      .call('com.para.civic.getOpenQuestionThread', params, undefined, opts)
      .catch((e) => {
        throw ComParaCivicGetOpenQuestionThread.toKnownErr(e)
      })
  }
...
export class ComParaCivicAmendmentRecord {
  _client: XrpcClient
  ...
  async list(
    ...
    cursor?: string
    records: { uri: string; value: ComParaCivicAmendment.Record }[]
  }> {
    const res = await this._client.call('com.atproto.repo.listRecords', {
      collection: 'com.para.civic.amendment',
      ...params,
    })
    return res.data
  }
  ...
  async get(
    ...
    uri: string
    cid: string
    value: ComParaCivicAmendment.Record
  }> {
    const res = await this._client.call('com.atproto.repo.getRecord', {
      collection: 'com.para.civic.amendment',
      ...params,
  ...
  async create(
    params: OmitKey<
      ...
      'collection' | 'record'
    >,
    record: Un$Typed<ComParaCivicAmendment.Record>,
    headers?: Record<string, string>,
  ): Promise<{ uri: string; cid: string }> {
    const collection = 'com.para.civic.amendment'
    const res = await this._client.call(
      'com.atproto.repo.createRecord',
      undefined,
      { collection, ...params, record: { ...record, $type: collection } },
  ...
  async delete(
    ...
    await this._client.call(
      'com.atproto.repo.deleteRecord',
      undefined,
      { collection: 'com.para.civic.amendment', ...params },
      { headers },
    )
  }
}
...
export class ComParaCivicOpenQuestionRecord {
  _client: XrpcClient
  ...
  async list(
    ...
    cursor?: string
    records: { uri: string; value: ComParaCivicOpenQuestion.Record }[]
  }> {
    const res = await this._client.call('com.atproto.repo.listRecords', {
      collection: 'com.para.civic.openQuestion',
      ...params,
    })
    return res.data
  }
  ...
  async get(
    ...
    uri: string
    cid: string
    value: ComParaCivicOpenQuestion.Record
  }> {
    const res = await this._client.call('com.atproto.repo.getRecord', {
      collection: 'com.para.civic.openQuestion',
      ...params,
  ...
  async create(
    params: OmitKey<
      ...
      'collection' | 'record'
    >,
    record: Un$Typed<ComParaCivicOpenQuestion.Record>,
    headers?: Record<string, string>,
  ): Promise<{ uri: string; cid: string }> {
    const collection = 'com.para.civic.openQuestion'
    const res = await this._client.call(
      'com.atproto.repo.createRecord',
      undefined,
      { collection, ...params, record: { ...record, $type: collection } },
  ...
  async delete(
    ...
    await this._client.call(
      'com.atproto.repo.deleteRecord',
      undefined,
      { collection: 'com.para.civic.openQuestion', ...params },
      { headers },
    )
  }
}

export class ComParaCivicOpenQuestionVoteRecord {
  _client: XrpcClient
  ...
  async list(
    ...
    cursor?: string
    records: { uri: string; value: ComParaCivicOpenQuestionVote.Record }[]
  }> {
    const res = await this._client.call('com.atproto.repo.listRecords', {
  ...
  async get(
    ...
    uri: string
    cid: string
    value: ComParaCivicOpenQuestionVote.Record
  }> {
    const res = await this._client.call('com.atproto.repo.getRecord', {
      collection: 'com.para.civic.openQuestionVote',
      ...params,
  ...
  async create(
    params: OmitKey<
      ...
      'collection' | 'record'
    >,
    record: Un$Typed<ComParaCivicOpenQuestionVote.Record>,
    headers?: Record<string, string>,
  ): Promise<{ uri: string; cid: string }> {
    const collection = 'com.para.civic.openQuestionVote'
    const res = await this._client.call(
      'com.atproto.repo.createRecord',
      undefined,
      { collection, ...params, record: { ...record, $type: collection } },
  ...
  async delete(
    ...
    await this._client.call(
      'com.atproto.repo.deleteRecord',
      undefined,
      { collection: 'com.para.civic.openQuestionVote', ...params },
      { headers },
    )
  }
}
...
export class ComParaCollectionNS {
  _client: XrpcClient
  ...
  ): Promise<ComParaCollectionCreateCollection.Response> {
    return this._client.call(
  ...
  deleteCollection(
    data?: ComParaCollectionDeleteCollection.InputSchema,
    opts?: ComParaCollectionDeleteCollection.CallOptions,
  ): Promise<ComParaCollectionDeleteCollection.Response> {
    return this._client.call(
  ...
  getCollection(
    params?: ComParaCollectionGetCollection.QueryParams,
    opts?: ComParaCollectionGetCollection.CallOptions,
  ): Promise<ComParaCollectionGetCollection.Response> {
    return this._client
      .call('com.para.collection.getCollection', params, undefined, opts)
      .catch((e) => {
        throw ComParaCollectionGetCollection.toKnownErr(e)
      })
  }

  listCollections(
    params?: ComParaCollectionListCollections.QueryParams,
    opts?: ComParaCollectionListCollections.CallOptions,
  ): Promise<ComParaCollectionListCollections.Response> {
    return this._client.call(
  ...
  updateCollection(
    data?: ComParaCollectionUpdateCollection.InputSchema,
    opts?: ComParaCollectionUpdateCollection.CallOptions,
  ): Promise<ComParaCollectionUpdateCollection.Response> {
    return this._client
      .call('com.para.collection.updateCollection', opts?.qp, data, opts)
      .catch((e) => {
        throw ComParaCollectionUpdateCollection.toKnownErr(e)
      })
  }
}
...
export class ComParaCommunityNS {
  ...
  intensity: ComParaCommunityIntensityRecord
  ...
  constructor(client: XrpcClient) {
    ...
    this.intensity = new ComParaCommunityIntensityRecord(client)
  ...
  getTallySimulation(
    params?: ComParaCommunityGetTallySimulation.QueryParams,
    opts?: ComParaCommunityGetTallySimulation.CallOptions,
  ): Promise<ComParaCommunityGetTallySimulation.Response> {
    return this._client.call(
  ...
  listChildCommunities(
    params?: ComParaCommunityListChildCommunities.QueryParams,
    opts?: ComParaCommunityListChildCommunities.CallOptions,
  ): Promise<ComParaCommunityListChildCommunities.Response> {
    return this._client.call(
  ...
  ): Promise<ComParaCommunityListCommunityRelations.Response> {
    return this._client.call(
  ...
  listDelegations(
    params?: ComParaCommunityListDelegations.QueryParams,
    opts?: ComParaCommunityListDelegations.CallOptions,
  ...
  listIntensities(
    params?: ComParaCommunityListIntensities.QueryParams,
    opts?: ComParaCommunityListIntensities.CallOptions,
  ): Promise<ComParaCommunityListIntensities.Response> {
    return this._client.call(
  ...
  listParentCommunities(
    params?: ComParaCommunityListParentCommunities.QueryParams,
    opts?: ComParaCommunityListParentCommunities.CallOptions,
  ): Promise<ComParaCommunityListParentCommunities.Response> {
    return this._client.call(
      'com.para.community.listParentCommunities',
      params,
      undefined,
      opts,
    )
  ...
  listSharedContent(
    params?: ComParaCommunityListSharedContent.QueryParams,
    opts?: ComParaCommunityListSharedContent.CallOptions,
  ): Promise<ComParaCommunityListSharedContent.Response> {
    return this._client.call(
  ...
  listVotes(
    params?: ComParaCommunityListVotes.QueryParams,
    opts?: ComParaCommunityListVotes.CallOptions,
  ): Promise<ComParaCommunityListVotes.Response> {
    return this._client.call(
      'com.para.community.listVotes',
      params,
      undefined,
      opts,
    )
  ...
  ): Promise<ComParaCommunityRemoveSharedContent.Response> {
    return this._client.call(
  ...
  restoreSharedContent(
    data?: ComParaCommunityRestoreSharedContent.InputSchema,
    opts?: ComParaCommunityRestoreSharedContent.CallOptions,
  ): Promise<ComParaCommunityRestoreSharedContent.Response> {
    return this._client.call(
  ...
  shareContent(
    data?: ComParaCommunityShareContent.InputSchema,
    opts?: ComParaCommunityShareContent.CallOptions,
  ): Promise<ComParaCommunityShareContent.Response> {
    return this._client.call(
...
export class ComParaCommunityConstitutionRecord {
  _client: XrpcClient
  ...
  async list(
    ...
    cursor?: string
    records: { uri: string; value: ComParaCommunityConstitution.Record }[]
  }> {
    const res = await this._client.call('com.atproto.repo.listRecords', {
      collection: 'com.para.community.constitution',
      ...params,
    })
    return res.data
  }
  ...
  async get(
    ...
    uri: string
    cid: string
    value: ComParaCommunityConstitution.Record
  }> {
    const res = await this._client.call('com.atproto.repo.getRecord', {
      collection: 'com.para.community.constitution',
      ...params,
  ...
  async create(
    params: OmitKey<
      ...
      'collection' | 'record'
    >,
    record: Un$Typed<ComParaCommunityConstitution.Record>,
    headers?: Record<string, string>,
  ): Promise<{ uri: string; cid: string }> {
    const collection = 'com.para.community.constitution'
    const res = await this._client.call(
      'com.atproto.repo.createRecord',
      undefined,
      { collection, ...params, record: { ...record, $type: collection } },
  ...
  async delete(
    ...
    await this._client.call(
      'com.atproto.repo.deleteRecord',
      undefined,
      { collection: 'com.para.community.constitution', ...params },
      { headers },
    )
  }
}

export class ComParaCommunityDecisionRecord {
  _client: XrpcClient
  ...
  async list(
    ...
    cursor?: string
    records: { uri: string; value: ComParaCommunityDecision.Record }[]
  }> {
    const res = await this._client.call('com.atproto.repo.listRecords', {
      collection: 'com.para.community.decision',
      ...params,
    })
    return res.data
  }
  ...
  async get(
    ...
    uri: string
    cid: string
    value: ComParaCommunityDecision.Record
  }> {
    const res = await this._client.call('com.atproto.repo.getRecord', {
      collection: 'com.para.community.decision',
      ...params,
  ...
  async create(
    params: OmitKey<
      ...
      'collection' | 'record'
    >,
    record: Un$Typed<ComParaCommunityDecision.Record>,
    headers?: Record<string, string>,
  ): Promise<{ uri: string; cid: string }> {
    const collection = 'com.para.community.decision'
    const res = await this._client.call(
      'com.atproto.repo.createRecord',
      undefined,
      { collection, ...params, record: { ...record, $type: collection } },
  ...
  async delete(
    ...
    await this._client.call(
      'com.atproto.repo.deleteRecord',
      undefined,
      { collection: 'com.para.community.decision', ...params },
      { headers },
    )
  }
}

export class ComParaCommunityDelegationRecord {
  _client: XrpcClient
  ...
  async list(
    ...
    cursor?: string
    records: { uri: string; value: ComParaCommunityDelegation.Record }[]
  }> {
    const res = await this._client.call('com.atproto.repo.listRecords', {
  ...
  async get(
    ...
    uri: string
    cid: string
    value: ComParaCommunityDelegation.Record
  }> {
    const res = await this._client.call('com.atproto.repo.getRecord', {
      collection: 'com.para.community.delegation',
      ...params,
  ...
  async create(
    params: OmitKey<
      ...
      'collection' | 'record'
    >,
    record: Un$Typed<ComParaCommunityDelegation.Record>,
    headers?: Record<string, string>,
  ): Promise<{ uri: string; cid: string }> {
    const collection = 'com.para.community.delegation'
    const res = await this._client.call(
      'com.atproto.repo.createRecord',
      undefined,
      { collection, ...params, record: { ...record, $type: collection } },
...
export class ComParaCommunityEigenstateRecord {
  ...
  async list(
    ...
    cursor?: string
    records: { uri: string; value: ComParaCommunityEigenstate.Record }[]
  }> {
    const res = await this._client.call('com.atproto.repo.listRecords', {
      collection: 'com.para.community.eigenstate',
      ...params,
    })
    return res.data
  }
  ...
  async get(
    ...
    uri: string
    cid: string
    value: ComParaCommunityEigenstate.Record
  }> {
    const res = await this._client.call('com.atproto.repo.getRecord', {
      collection: 'com.para.community.eigenstate',
      ...params,
  ...
  async create(
    params: OmitKey<
      ...
      'collection' | 'record'
    >,
    record: Un$Typed<ComParaCommunityEigenstate.Record>,
    headers?: Record<string, string>,
  ): Promise<{ uri: string; cid: string }> {
    const collection = 'com.para.community.eigenstate'
    const res = await this._client.call(
      'com.atproto.repo.createRecord',
      undefined,
      { collection, ...params, record: { ...record, $type: collection } },
  ...
  async delete(
    ...
    await this._client.call(
      'com.atproto.repo.deleteRecord',
      undefined,
      { collection: 'com.para.community.eigenstate', ...params },
      { headers },
    )
  }
}
...
export class ComParaCommunityGovernanceConfigRecord {
  _client: XrpcClient
  ...
  async list(
    ...
    cursor?: string
    records: { uri: string; value: ComParaCommunityGovernanceConfig.Record }[]
  }> {
    const res = await this._client.call('com.atproto.repo.listRecords', {
      collection: 'com.para.community.governanceConfig',
      ...params,
    })
    return res.data
  }
  ...
  async get(
    ...
    uri: string
    cid: string
    value: ComParaCommunityGovernanceConfig.Record
  }> {
    const res = await this._client.call('com.atproto.repo.getRecord', {
      collection: 'com.para.community.governanceConfig',
      ...params,
  ...
  async create(
    params: OmitKey<
      ...
      'collection' | 'record'
    >,
    record: Un$Typed<ComParaCommunityGovernanceConfig.Record>,
    headers?: Record<string, string>,
  ): Promise<{ uri: string; cid: string }> {
    const collection = 'com.para.community.governanceConfig'
    const res = await this._client.call(
      'com.atproto.repo.createRecord',
      undefined,
      { collection, ...params, record: { ...record, $type: collection } },
  ...
  async delete(
    ...
    await this._client.call(
      'com.atproto.repo.deleteRecord',
      undefined,
      { collection: 'com.para.community.governanceConfig', ...params },
      { headers },
    )
  }
}

export class ComParaCommunityIntensityRecord {
  _client: XrpcClient
  ...
  async list(
    ...
    cursor?: string
    records: { uri: string; value: ComParaCommunityIntensity.Record }[]
  }> {
    const res = await this._client.call('com.atproto.repo.listRecords', {
  ...
  async get(
    ...
    uri: string
    cid: string
    value: ComParaCommunityIntensity.Record
  }> {
    const res = await this._client.call('com.atproto.repo.getRecord', {
      collection: 'com.para.community.intensity',
      ...params,
  ...
  async create(
    params: OmitKey<
      ...
      'collection' | 'record'
    >,
    record: Un$Typed<ComParaCommunityIntensity.Record>,
    headers?: Record<string, string>,
  ): Promise<{ uri: string; cid: string }> {
    const collection = 'com.para.community.intensity'
    const res = await this._client.call(
      'com.atproto.repo.createRecord',
      undefined,
      { collection, ...params, record: { ...record, $type: collection } },
  ...
  async delete(
    ...
    await this._client.call(
      'com.atproto.repo.deleteRecord',
      undefined,
      { collection: 'com.para.community.intensity', ...params },
      { headers },
    )
  }
}
...
export class ComParaCommunityProposalRecord {
  _client: XrpcClient
  ...
  async list(
    ...
    cursor?: string
    records: { uri: string; value: ComParaCommunityProposal.Record }[]
  }> {
    const res = await this._client.call('com.atproto.repo.listRecords', {
  ...
  async get(
    ...
    uri: string
    cid: string
    value: ComParaCommunityProposal.Record
  }> {
    const res = await this._client.call('com.atproto.repo.getRecord', {
      collection: 'com.para.community.proposal',
      ...params,
  ...
  async create(
    params: OmitKey<
      ...
      'collection' | 'record'
    >,
    record: Un$Typed<ComParaCommunityProposal.Record>,
    headers?: Record<string, string>,
  ): Promise<{ uri: string; cid: string }> {
    const collection = 'com.para.community.proposal'
    const res = await this._client.call(
      'com.atproto.repo.createRecord',
      undefined,
      { collection, ...params, record: { ...record, $type: collection } },
  ...
  async delete(
    ...
    await this._client.call(
      'com.atproto.repo.deleteRecord',
      undefined,
      { collection: 'com.para.community.proposal', ...params },
      { headers },
    )
  }
}

export class ComParaCommunityRelationRecord {
  _client: XrpcClient
  ...
  async list(
    ...
    cursor?: string
    records: { uri: string; value: ComParaCommunityRelation.Record }[]
  }> {
    const res = await this._client.call('com.atproto.repo.listRecords', {
      collection: 'com.para.community.relation',
      ...params,
    })
    return res.data
  }
  ...
  async get(
    ...
    uri: string
    cid: string
    value: ComParaCommunityRelation.Record
  }> {
    const res = await this._client.call('com.atproto.repo.getRecord', {
      collection: 'com.para.community.relation',
      ...params,
  ...
  async create(
    params: OmitKey<
      ...
      'collection' | 'record'
    >,
    record: Un$Typed<ComParaCommunityRelation.Record>,
    headers?: Record<string, string>,
  ): Promise<{ uri: string; cid: string }> {
    const collection = 'com.para.community.relation'
    const res = await this._client.call(
      'com.atproto.repo.createRecord',
      undefined,
      { collection, ...params, record: { ...record, $type: collection } },
...
export class ComParaCommunitySharedContentRecord {
  _client: XrpcClient
  ...
  async list(
    ...
    cursor?: string
    records: { uri: string; value: ComParaCommunitySharedContent.Record }[]
  }> {
    const res = await this._client.call('com.atproto.repo.listRecords', {
      collection: 'com.para.community.sharedContent',
      ...params,
    })
    return res.data
  }
  ...
  async get(
    ...
    uri: string
    cid: string
    value: ComParaCommunitySharedContent.Record
  }> {
    const res = await this._client.call('com.atproto.repo.getRecord', {
      collection: 'com.para.community.sharedContent',
      ...params,
  ...
  async create(
    params: OmitKey<
      ...
      'collection' | 'record'
    >,
    record: Un$Typed<ComParaCommunitySharedContent.Record>,
    headers?: Record<string, string>,
  ): Promise<{ uri: string; cid: string }> {
    const collection = 'com.para.community.sharedContent'
    const res = await this._client.call(
      'com.atproto.repo.createRecord',
      undefined,
      { collection, ...params, record: { ...record, $type: collection } },
  ...
  async delete(
    ...
    await this._client.call(
      'com.atproto.repo.deleteRecord',
      undefined,
      { collection: 'com.para.community.sharedContent', ...params },
      { headers },
    )
  }
}

export class ComParaCommunitySharedContentActionRecord {
  _client: XrpcClient
  ...
  async list(
    ...
    records: {
      uri: string
      value: ComParaCommunitySharedContentAction.Record
    }[]
  }> {
    const res = await this._client.call('com.atproto.repo.listRecords', {
      collection: 'com.para.community.sharedContentAction',
      ...params,
    })
    return res.data
  }
  ...
  async create(
    params: OmitKey<
      ...
      'collection' | 'record'
    >,
    record: Un$Typed<ComParaCommunitySharedContentAction.Record>,
    headers?: Record<string, string>,
  ): Promise<{ uri: string; cid: string }> {
    const collection = 'com.para.community.sharedContentAction'
    const res = await this._client.call(
      'com.atproto.repo.createRecord',
      undefined,
      { collection, ...params, record: { ...record, $type: collection } },
  ...
  async delete(
    ...
    await this._client.call(
      'com.atproto.repo.deleteRecord',
      undefined,
      { collection: 'com.para.community.sharedContentAction', ...params },
      { headers },
    )
  }
}
...
export class ComParaCommunityVoteRecord {
  ...
  async list(
    ...
    cursor?: string
    records: { uri: string; value: ComParaCommunityVote.Record }[]
  }> {
    const res = await this._client.call('com.atproto.repo.listRecords', {
  ...
  async get(
    params: OmitKey<ComAtprotoRepoGetRecord.QueryParams, 'collection'>,
  ): Promise<{ uri: string; cid: string; value: ComParaCommunityVote.Record }> {
    const res = await this._client.call('com.atproto.repo.getRecord', {
      collection: 'com.para.community.vote',
      ...params,
    })
  ...
  async create(
    params: OmitKey<
      ...
      'collection' | 'record'
    >,
    record: Un$Typed<ComParaCommunityVote.Record>,
    headers?: Record<string, string>,
  ): Promise<{ uri: string; cid: string }> {
    const collection = 'com.para.community.vote'
    const res = await this._client.call(
      'com.atproto.repo.createRecord',
      undefined,
      { collection, ...params, record: { ...record, $type: collection } },
...
export class ComParaDiscourseNS {
  ...
  getAnalysis(
    params?: ComParaDiscourseGetAnalysis.QueryParams,
    opts?: ComParaDiscourseGetAnalysis.CallOptions,
  ): Promise<ComParaDiscourseGetAnalysis.Response> {
    return this._client.call(
      'com.para.discourse.getAnalysis',
      params,
      undefined,
      opts,
    )
  ...
  getTopology(
    params?: ComParaDiscourseGetTopology.QueryParams,
    opts?: ComParaDiscourseGetTopology.CallOptions,
  ): Promise<ComParaDiscourseGetTopology.Response> {
    return this._client.call(
...
export class ComParaOfficialNS {
  _client: XrpcClient
  action: ComParaOfficialActionRecord
  controller: ComParaOfficialControllerRecord
  entity: ComParaOfficialEntityRecord

  constructor(client: XrpcClient) {
    this._client = client
    this.action = new ComParaOfficialActionRecord(client)
    this.controller = new ComParaOfficialControllerRecord(client)
    this.entity = new ComParaOfficialEntityRecord(client)
  }
}

export class ComParaOfficialActionRecord {
  _client: XrpcClient
  ...
  async list(
    ...
    cursor?: string
    records: { uri: string; value: ComParaOfficialAction.Record }[]
  }> {
    const res = await this._client.call('com.atproto.repo.listRecords', {
      collection: 'com.para.official.action',
      ...params,
    })
    return res.data
  }
  ...
  async get(
    ...
    uri: string
    cid: string
    value: ComParaOfficialAction.Record
  }> {
    const res = await this._client.call('com.atproto.repo.getRecord', {
      collection: 'com.para.official.action',
      ...params,
  ...
  async create(
    params: OmitKey<
      ...
      'collection' | 'record'
    >,
    record: Un$Typed<ComParaOfficialAction.Record>,
    headers?: Record<string, string>,
  ): Promise<{ uri: string; cid: string }> {
    const collection = 'com.para.official.action'
    const res = await this._client.call(
      'com.atproto.repo.createRecord',
      undefined,
      { collection, ...params, record: { ...record, $type: collection } },
  ...
  async delete(
    ...
    await this._client.call(
      'com.atproto.repo.deleteRecord',
      undefined,
      { collection: 'com.para.official.action', ...params },
      { headers },
    )
  }
}

export class ComParaOfficialControllerRecord {
  _client: XrpcClient
  ...
  async list(
    ...
    cursor?: string
    records: { uri: string; value: ComParaOfficialController.Record }[]
  }> {
    const res = await this._client.call('com.atproto.repo.listRecords', {
      collection: 'com.para.official.controller',
      ...params,
    })
    return res.data
  }
  ...
  async get(
    ...
    uri: string
    cid: string
    value: ComParaOfficialController.Record
  }> {
    const res = await this._client.call('com.atproto.repo.getRecord', {
      collection: 'com.para.official.controller',
      ...params,
  ...
  async create(
    params: OmitKey<
      ...
      'collection' | 'record'
    >,
    record: Un$Typed<ComParaOfficialController.Record>,
    headers?: Record<string, string>,
  ): Promise<{ uri: string; cid: string }> {
    const collection = 'com.para.official.controller'
    const res = await this._client.call(
      'com.atproto.repo.createRecord',
      undefined,
      { collection, ...params, record: { ...record, $type: collection } },
  ...
  async delete(
    ...
    await this._client.call(
      'com.atproto.repo.deleteRecord',
      undefined,
      { collection: 'com.para.official.controller', ...params },
      { headers },
    )
  }
}

export class ComParaOfficialEntityRecord {
  _client: XrpcClient
  ...
  async list(
    ...
    cursor?: string
    records: { uri: string; value: ComParaOfficialEntity.Record }[]
  }> {
    const res = await this._client.call('com.atproto.repo.listRecords', {
      collection: 'com.para.official.entity',
      ...params,
    })
    return res.data
  }
  ...
  async get(
    ...
    uri: string
    cid: string
    value: ComParaOfficialEntity.Record
  }> {
    const res = await this._client.call('com.atproto.repo.getRecord', {
      collection: 'com.para.official.entity',
      ...params,
  ...
  async create(
    params: OmitKey<
      ...
      'collection' | 'record'
    >,
    record: Un$Typed<ComParaOfficialEntity.Record>,
    headers?: Record<string, string>,
  ): Promise<{ uri: string; cid: string }> {
    const collection = 'com.para.official.entity'
    const res = await this._client.call(
      'com.atproto.repo.createRecord',
      undefined,
      { collection, ...params, record: { ...record, $type: collection } },
  ...
  async delete(
    ...
    await this._client.call(
      'com.atproto.repo.deleteRecord',
      undefined,
      { collection: 'com.para.official.entity', ...params },
      { headers },
    )
  }
}

export class ComParaRaqNS {
  _client: XrpcClient
  assessment: ComParaRaqAssessmentRecord
  axisVote: ComParaRaqAxisVoteRecord
  proposal: ComParaRaqProposalRecord
  proposalAnswer: ComParaRaqProposalAnswerRecord
  proposalVote: ComParaRaqProposalVoteRecord

  constructor(client: XrpcClient) {
    this._client = client
    this.assessment = new ComParaRaqAssessmentRecord(client)
    this.axisVote = new ComParaRaqAxisVoteRecord(client)
    this.proposal = new ComParaRaqProposalRecord(client)
    this.proposalAnswer = new ComParaRaqProposalAnswerRecord(client)
    this.proposalVote = new ComParaRaqProposalVoteRecord(client)
  }

  getCommunityAlignment(
    params?: ComParaRaqGetCommunityAlignment.QueryParams,
    opts?: ComParaRaqGetCommunityAlignment.CallOptions,
  ): Promise<ComParaRaqGetCommunityAlignment.Response> {
    return this._client
      .call('com.para.raq.getCommunityAlignment', params, undefined, opts)
      .catch((e) => {
        throw ComParaRaqGetCommunityAlignment.toKnownErr(e)
      })
  }

  getProposals(
    params?: ComParaRaqGetProposals.QueryParams,
    opts?: ComParaRaqGetProposals.CallOptions,
  ): Promise<ComParaRaqGetProposals.Response> {
    return this._client.call(
      'com.para.raq.getProposals',
      params,
      undefined,
      opts,
    )
  ...
  getUserAlignment(
    params?: ComParaRaqGetUserAlignment.QueryParams,
    opts?: ComParaRaqGetUserAlignment.CallOptions,
  ): Promise<ComParaRaqGetUserAlignment.Response> {
    return this._client
      .call('com.para.raq.getUserAlignment', params, undefined, opts)
      .catch((e) => {
        throw ComParaRaqGetUserAlignment.toKnownErr(e)
      })
  }
}

export class ComParaRaqAssessmentRecord {
  _client: XrpcClient
  ...
  async list(
    ...
    cursor?: string
    records: { uri: string; value: ComParaRaqAssessment.Record }[]
  }> {
    const res = await this._client.call('com.atproto.repo.listRecords', {
  ...
  async get(
    params: OmitKey<ComAtprotoRepoGetRecord.QueryParams, 'collection'>,
  ): Promise<{ uri: string; cid: string; value: ComParaRaqAssessment.Record }> {
    const res = await this._client.call('com.atproto.repo.getRecord', {
      collection: 'com.para.raq.assessment',
      ...params,
    })
  ...
  async create(
    params: OmitKey<
      ...
      'collection' | 'record'
    >,
    record: Un$Typed<ComParaRaqAssessment.Record>,
    headers?: Record<string, string>,
  ): Promise<{ uri: string; cid: string }> {
    const collection = 'com.para.raq.assessment'
    const res = await this._client.call(
      'com.atproto.repo.createRecord',
      undefined,
      { collection, ...params, record: { ...record, $type: collection } },
  ...
  async delete(
    ...
    await this._client.call(
      'com.atproto.repo.deleteRecord',
      undefined,
      { collection: 'com.para.raq.assessment', ...params },
      { headers },
    )
  }
}

export class ComParaRaqAxisVoteRecord {
  _client: XrpcClient
  ...
  async list(
    ...
    cursor?: string
    records: { uri: string; value: ComParaRaqAxisVote.Record }[]
  }> {
    const res = await this._client.call('com.atproto.repo.listRecords', {
  ...
  async get(
    params: OmitKey<ComAtprotoRepoGetRecord.QueryParams, 'collection'>,
  ): Promise<{ uri: string; cid: string; value: ComParaRaqAxisVote.Record }> {
    const res = await this._client.call('com.atproto.repo.getRecord', {
      collection: 'com.para.raq.axisVote',
      ...params,
    })
  ...
  async create(
    params: OmitKey<
      ...
      'collection' | 'record'
    >,
    record: Un$Typed<ComParaRaqAxisVote.Record>,
    headers?: Record<string, string>,
  ): Promise<{ uri: string; cid: string }> {
    const collection = 'com.para.raq.axisVote'
    const res = await this._client.call(
      'com.atproto.repo.createRecord',
      undefined,
      { collection, ...params, record: { ...record, $type: collection } },
  ...
  async delete(
    ...
    await this._client.call(
      'com.atproto.repo.deleteRecord',
      undefined,
      { collection: 'com.para.raq.axisVote', ...params },
      { headers },
    )
  }
}

export class ComParaRaqProposalRecord {
  _client: XrpcClient
  ...
  async list(
    ...
    cursor?: string
    records: { uri: string; value: ComParaRaqProposal.Record }[]
  }> {
    const res = await this._client.call('com.atproto.repo.listRecords', {
  ...
  async get(
    params: OmitKey<ComAtprotoRepoGetRecord.QueryParams, 'collection'>,
  ): Promise<{ uri: string; cid: string; value: ComParaRaqProposal.Record }> {
    const res = await this._client.call('com.atproto.repo.getRecord', {
      collection: 'com.para.raq.proposal',
      ...params,
    })
  ...
  async create(
    params: OmitKey<
      ...
      'collection' | 'record'
    >,
    record: Un$Typed<ComParaRaqProposal.Record>,
    headers?: Record<string, string>,
  ): Promise<{ uri: string; cid: string }> {
    const collection = 'com.para.raq.proposal'
    const res = await this._client.call(
      'com.atproto.repo.createRecord',
      undefined,
      { collection, ...params, record: { ...record, $type: collection } },
  ...
  async delete(
    ...
    await this._client.call(
      'com.atproto.repo.deleteRecord',
      undefined,
      { collection: 'com.para.raq.proposal', ...params },
      { headers },
    )
  }
}

export class ComParaRaqProposalAnswerRecord {
  _client: XrpcClient
  ...
  async list(
    ...
    cursor?: string
    records: { uri: string; value: ComParaRaqProposalAnswer.Record }[]
  }> {
    const res = await this._client.call('com.atproto.repo.listRecords', {
  ...
  async get(
    ...
    uri: string
    cid: string
    value: ComParaRaqProposalAnswer.Record
  }> {
    const res = await this._client.call('com.atproto.repo.getRecord', {
      collection: 'com.para.raq.proposalAnswer',
      ...params,
  ...
  async create(
    params: OmitKey<
      ...
      'collection' | 'record'
    >,
    record: Un$Typed<ComParaRaqProposalAnswer.Record>,
    headers?: Record<string, string>,
  ): Promise<{ uri: string; cid: string }> {
    const collection = 'com.para.raq.proposalAnswer'
    const res = await this._client.call(
      'com.atproto.repo.createRecord',
      undefined,
      { collection, ...params, record: { ...record, $type: collection } },
  ...
  async delete(
    ...
    await this._client.call(
      'com.atproto.repo.deleteRecord',
      undefined,
      { collection: 'com.para.raq.proposalAnswer', ...params },
      { headers },
    )
  }
}

export class ComParaRaqProposalVoteRecord {
  _client: XrpcClient
  ...
  async list(
    ...
    cursor?: string
    records: { uri: string; value: ComParaRaqProposalVote.Record }[]
  }> {
    const res = await this._client.call('com.atproto.repo.listRecords', {
  ...
  async get(
    ...
    uri: string
    cid: string
    value: ComParaRaqProposalVote.Record
  }> {
    const res = await this._client.call('com.atproto.repo.getRecord', {
      collection: 'com.para.raq.proposalVote',
      ...params,
  ...
  async create(
    params: OmitKey<
      ...
      'collection' | 'record'
    >,
    record: Un$Typed<ComParaRaqProposalVote.Record>,
    headers?: Record<string, string>,
  ): Promise<{ uri: string; cid: string }> {
    const collection = 'com.para.raq.proposalVote'
    const res = await this._client.call(
      'com.atproto.repo.createRecord',
      undefined,
      { collection, ...params, record: { ...record, $type: collection } },
  ...
  async delete(
    ...
    await this._client.call(
      'com.atproto.repo.deleteRecord',
      undefined,
      { collection: 'com.para.raq.proposalVote', ...params },
      { headers },
    )
  }
}
...
export class ComParaSortitionNS {
  _client: XrpcClient
  proof: ComParaSortitionProofRecord

  constructor(client: XrpcClient) {
    this._client = client
    this.proof = new ComParaSortitionProofRecord(client)
  }
}

export class ComParaSortitionProofRecord {
  _client: XrpcClient
  ...
  async list(
    ...
    cursor?: string
    records: { uri: string; value: ComParaSortitionProof.Record }[]
  }> {
    const res = await this._client.call('com.atproto.repo.listRecords', {
      collection: 'com.para.sortition.proof',
      ...params,
    })
    return res.data
  }
  ...
  async get(
    ...
    uri: string
    cid: string
    value: ComParaSortitionProof.Record
  }> {
    const res = await this._client.call('com.atproto.repo.getRecord', {
      collection: 'com.para.sortition.proof',
      ...params,
  ...
  async create(
    params: OmitKey<
      ...
      'collection' | 'record'
    >,
    record: Un$Typed<ComParaSortitionProof.Record>,
    headers?: Record<string, string>,
  ): Promise<{ uri: string; cid: string }> {
    const collection = 'com.para.sortition.proof'
    const res = await this._client.call(
      'com.atproto.repo.createRecord',
      undefined,
      { collection, ...params, record: { ...record, $type: collection } },
  ...
  async delete(
    ...
    await this._client.call(
      'com.atproto.repo.deleteRecord',
      undefined,
      { collection: 'com.para.sortition.proof', ...params },
      { headers },
    )
  }
}
