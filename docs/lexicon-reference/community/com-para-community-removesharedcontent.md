---
title: com.para.community.removeSharedContent
description: Reference for the com.para.community.removeSharedContent lexicon
---
**Lexicon Version:** 1
...
Hides a sharedContent wrapper from a community feed by creating a moderation action record.
...
```json
{
  ...
  "defs": {
    "main": {
      "type": "procedure",
      "description": "Hides a sharedContent wrapper from a community feed by creating a moderation action record.",
      "input": {
        "encoding": "application/json",
        "schema": {
          "type": "ref",
